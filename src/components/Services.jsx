...
const Services = () => {
  ...
  const services = [
    ...
    {
      icon: <Film size={32} />,
      title: 'GIF & Short Videos',
      description: 'Creating engaging animated GIFs and short videos that capture attention and bring your content to life.',
      features: ['Animated GIFs', 'Promo Videos', 'Motion Graphics'],
      color: '#00d2d3',
      detailedDescription: 'Dynamic motion content that captures attention. I create GIFs, short videos, and motion graphics that bring your brand to life and boost engagement.',
      process: ['Concept Development', 'Storyboarding', 'Animation', 'Sound Design', 'Export & Optimization'],
      deliverables: ['Animated GIFs', 'MP4 Videos', 'Social Media Formats', 'Loop Animations', 'Source Files'],
      works: [
